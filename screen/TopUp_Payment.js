...
export default class TopUp_Payment extends Component {
  render() {
    ...
    <View style={styles.Container}>
      <Text style={{color:"#58595B", fontSize:14, marginBottom:20}}>Choose top up method to reach your dream faster. </Text>
      <TouchableOpacity style={styles.ContentBox} onPress = {() => navigate("TopUp_Done")} >
