...
export default class GoalAhead extends Component {
  render() {
    ...
    return (
      ...
      <ScrollView>
          <LinearGradient start={{x: 0.0, y: 0.025}} end={{x: 1.0, y: 1.0}} colors={['#F5841F', '#DE6157']} style={{paddingTop:50}}>
          <Text style={{fontSize:36, color:'#FFFFFF',paddingLeft:30, marginBottom:16,  fontFamily:'TitilliumWeb-SemiBold'}}>New House</Text>
          </LinearGradient>
          ...
          <Slider style={{ width: 300, marginLeft:20}}
            ...
            />
          <Text style={{fontSize:12, color:'#000000',paddingLeft:30, marginBottom:20, fontFamily:'Roboto-Regular'}}>You are behind of your plan to reach your dream by Rp3.000.000,00.</Text>
