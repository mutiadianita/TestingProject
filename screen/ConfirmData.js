...
export default class Intro extends Component {
  ...
  <View style={{flex:1}}>
    <View style={{flexDirection: 'row', backgroundColor: "white", paddingTop:50}}>
      ...
      <Text style={{justifyContent: "center", fontSize:20, textAlign:"center", color: "white"}}> 2 </Text>
      </View>
      <View style={styles.Circle}>
    ...
    <View style={styles.container}>
      <Text style={{fontSize: 20, color: "#086BB3"}}> Confirm Your Data </Text>
      <Text style={{fontSize: 16, color: "#086BB3", marginLeft:20, marginRight:20, textAlign:"center"}}> Please take a picture of you with your KTP. </Text>
    </View>
